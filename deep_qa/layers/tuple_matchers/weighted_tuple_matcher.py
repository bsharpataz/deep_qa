...
class WeightedTupleMatcher:
    ...
    def __call__(self, inputs):
        ...
        weights_tuple1 = self.text_trainer._embed_input(tuple1)
        #weights_tuple2 = self.text_trainer._embed_input(tuple2)
        ...
        return match_layer([tuple1, tuple2, weights_tuple1])


# The first item added here will be used as the default in some cases.
weighted_tuple_matchers = OrderedDict()  # pylint: disable=invalid-name
weighted_tuple_matchers['word_overlap'] = WeightedOverlapTupleMatcher
