...
class GraphAlignInstance(TextInstance):
    """
        ...
        Parameters
        ----------
        answer_graphlets: List[ListList[List[float]]]]
...
class IndexedGraphAlignInstance(IndexedInstance):
    ...
    def get_lengths(self) -> Dict[str, int]:
        ...
        for answer in self.answers_indexed:
            ...
            answer_alignments, answer_features = self.get_lengths_from_indexed_tuples(answer)
    ...
    def pad_graphlet(self, graphlet_in: List[List[int]], padding_lengths: Dict):
        """
